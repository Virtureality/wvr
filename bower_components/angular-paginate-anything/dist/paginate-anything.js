    ...
    directive('bgfPagination', function () {
      ...
      return {
        ...
        templateUrl: function(element, attr) {
          ...
          return attr.templateUrl || 'bower_components/angular-paginate-anything/dist/paginate-anything.html';
        },
        replace: true,
        controller: ['$scope', '$http', function($scope, $http) {
          ...
          function requestRange(request) {
            ...
            $http({
              //method: 'GET',
              method: 'POST',
              data: {cid: 'fbl_api_54fbf04ed87c38e661e06a00'},
              //method: $scope.method !== null ? $scope.method : 'GET',
              url: $scope.url,
