...
(function() {
    ...
    window.DataConnection = function(channel) {
        ...
        function initSignaler() {
            console.log('initSignaler for DataConnection: ' + self);
    ...
    function Signaler(root) {
        ...
        function onSocketMessage(data) {
            console.log('DataConnection signaler called back with data: ' + data);
        ...
        this.onmessage = function(message) {
            console.log('DataConnection signaler got message: ' + message);
        ...
        function participationRequest(message) {
            console.log('Participation request: ' + message);
        ...
        var options = {
            ...
            onopen: function(e) {
                console.log('Opening channel for user: ' + e.userid);
    ...
    var Offer = {
        createOffer: function(config) {
            console.log('Creating offer: ' + config);
    ...
    var RTCDataChannel = {
        createDataChannel: function(peer, config) {
            console.log('Creating data channel for peer: ' + peer + ' with config: ' + config);
        ...
        setChannelEvents: function(channel, config) {
            console.log('Setting events for the channel: ' + channel);
    ...
    var TextSender = {
        send: function(config) {
            ...
            function send(message) {
                ...
                for (var channel in channels) {
                    console.log('Sending message' + message + 'for channel: ' + channel);
                    channels[channel].channel.send(message);
                }
            }
